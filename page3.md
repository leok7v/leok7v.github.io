...
as a principal software engineer and technical lead/architect of the system software team.

My duties included reviews of product development plans, subdivision of plans into achievable goals, translating goals into subprojects, architecting interfaces and implementation details of subprojects, and writing correct and robust code.

I've interviewed, hired, trained, and mentored new engineers in the art of software development.

I have led the team in developing state-of-the-art system software and assisted junior members of the team in all phases of s/w development: jumping in to do code reviews and helping to debug, test, and correct code when necessary. I also interfaced and collaborated extensively with the hardware team.
...
Major achievements:
 - [x] instrumental role in rearchitecting and reimplementing the complete IMU / IR-cameras triangulation pipeline for two systems that are built by the company and shipped to customers. Generated hundreds of millions of dollars in revenue for the company. 
 - [x] invented and implemented new FPGA-friendly algorithms for tracking controller hardware. 
 - [x] led the embedded Android AOSP initiative that resulted in a successful 3D VR laptop design, verification, development, and production. 
...
During my course of duty I have:
 ...
 - [x] implemented posix compliant hardware tests on both Linux (Embedded Android) and Windows
 ...
 - [x] rebuilt Android AOSP codebase to a headless version for OEM AmLogic SoC from scratch, resulting in a reduction of size from 1GB to 100MB and boot time from 30 seconds to 6 seconds
 ...
 *  TI Beagle Boards, Samsung XU4, Odroid C1, C2, Amlogic 905X, Blackfin...
 *  OmniVision and Aptina camera-sensor development boards
